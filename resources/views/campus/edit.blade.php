...
<div class="row">
    ...
    <div class="flip">
    <form method="post" action="{{ action('CampusController@update', $campus->id) }}">
    @csrf
   @method('PATCH')
   <div class="form-group">
      <input type="text" name="name" value="{{$campus->name}}" />
        ...
        <div class="form-group">
            <input type="number" name="phone" value="{{$campus->phone}}"> 
        </div>

        <div class="form-group">
            <input type="text" name="fax" value="{{$campus->fax}}">
        </div>
        
        <div class="form-group">
            <input type="email" name="email" value="{{$campus->email}}"> 
        </div>
